    ...
    return (
        <div className="w-full flex flex-col gap-10 justify-center items-center">
            ...
            <div className='flex flex-col gap-4 items-center max-w-md w-full'>
                            ...
                            <i onClick={togglePasswordVisiblity} className='cursor-pointer w-1/6 text-center flex justify-center items-center'>
                                {
                                    passwordShown
                                        ?
                                        <svg className="hover:stroke-eyeBlack" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <h2 className='text-white text-xl hover:opacity-70'>
                        <NavLink to='/register'>Create an Account</NavLink>
                    </h2>
                    <h3 className='text-white text-sm text-center text-urlGray hover:text-yellow'>
